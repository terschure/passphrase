...
- `content/targetPlan.js` parses level/sequence text and exposes default level data.
- `content/levelCatalog.js` builds level definitions and level-entry metadata
  from parsed Level 1 content and fixed Level 2 rounds.
